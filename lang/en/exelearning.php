...
$string['gradeenabled_help'] = 'When enabled (the default), the iDevices the author marked for assessment are tracked, shown as gradebook columns and in the reports. When disabled, the activity behaves like a plain resource: no grade columns and no reports. Attempts keep being recorded, so re-enabling this recovers the grades from that history.';
