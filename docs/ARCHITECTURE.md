...
| **API boundary** | `classes/external/*` (6 classes) | Web services for the mobile app; each validates context, login and capability. | The published Moodle external contract; fully declared in `db/services.php` ([[DEC-0040]]). |
