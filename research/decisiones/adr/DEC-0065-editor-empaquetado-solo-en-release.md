...
2. **Empaquetada** en `dist/static/` dentro del ZIP de release (obligatoria y reproducible desde
   [[DEC-0058]]: el editor se compila del tag homónimo y se declara en el `thirdpartylibs.xml` del
...
- Una versión del plugin ⇔ un build conocido del editor ([[DEC-0058]] queda como única vía).
