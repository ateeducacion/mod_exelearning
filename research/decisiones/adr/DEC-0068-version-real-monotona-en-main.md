...
> Supersede a [DEC-0030](DEC-0030-version-sentinela-en-main.md).

## Contexto

[[DEC-0030]] introdujo el centinela `$plugin->version = 9999999999` / `release = 'dev'` en
...
3. **El estampado por fecha rompe la reproducibilidad**: reconstruir el mismo tag otro día
   ...
   [[DEC-0058]] y [[DEC-0065]] persiguen para el editor.
...
|---|---|
| Mantener DEC-0030 tal cual | Brickea instalaciones reales y produce builds no reproducibles; DIR-03 lo señala y el PR 100 lo demostró en su propio sitio de pruebas. |
