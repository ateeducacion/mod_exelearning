...
siempre que el bundle del editor sea válido ([[DEC-106-01]]); no existe forma soportada de
...
- El CTA de "crear desde cero" ([[DEC-13-03]]) degrada solo: con el editor apagado el
...
| No hacer nada (quitar el bundle del paquete) | Rompe [[DEC-106-01]] (el empaquetado exige el editor) y castiga a los sitios que sí editan. |
